...
MessFee 0" > ~/"fees.txt"
    ...
    transactions=$(tail -n +5 ~/fees.txt)
...
MessFee $MessFee" > ~/"fees.txt"
        ...
        echo "$transactions" >> ~/file.txt
        echo TuitionFee:$TuitionFee::HostelRent:$HostelRent::ServiceCharge:$ServiceCharge::MessFee:$MessFee >> ~/file.txt
