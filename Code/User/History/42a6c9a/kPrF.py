...
path="/home/jagannathanm/Documents/sysdelta/studentDetails.txt"
mycursor.execute("load data infile %s into table Details FIELDS TERMINATED BY ' ' LINES TERMINATED BY '\n';",(path))
