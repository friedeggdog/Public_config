...
mycursor.execute("load data infile \"/var/lib/mysql-files/studentDetails.txt\" into table Details FIELDS TERMINATED BY ' ' (Name, Roll, Hostel, Room, Mess, MessPref) LINES TERMINATED BY '\n';")
