...
data = json.load(f)
for i in data:
    a.append(i['author']['username'][0].upper()+': '+i['content'])
f.close()

lbl1 = Label(root, borderwidth=0, bg='#313338', text=a[2], font=('sans-serif',12))
lbl1.grid(column = 1, row = 0, sticky=tk.NSEW, pady=5, padx=5)

lbl2 = Label(root, borderwidth=0, bg='#313338', text=a[1], font=('sans-serif',12))
lbl2.grid(column = 1, row = 1, sticky=tk.NSEW, pady=5, padx=5)

lbl3 = Label(root, borderwidth=0, bg='#313338', text=a[0], font=('sans-serif',12))
lbl3.grid(column = 1, row = 2, sticky=tk.NSEW, pady=5, padx=5)
