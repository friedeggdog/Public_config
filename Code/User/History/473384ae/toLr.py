...
for no,i in enumerate(data):
    Label(root, borderwidth=0, bg='#313338', text=i['author']['username'][0].upper()+': '+i['content'], font=('sans-serif',12), fg='#d3d6d9').grid(column = 1, row = 3-no, sticky=tk.W, pady=5, padx=5)
f.close()
