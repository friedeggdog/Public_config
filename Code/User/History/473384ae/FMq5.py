...
image2 = Image.open("/home/jagannathanm/programs/minDiscord/prof4.jpg")
...
lbl2.grid(column = 0, row = 1, sticky=tk.NSEW, pady=5, padx=5)
lbl2.grid(column = 0, row = 0, sticky=tk.NSEW, pady=5, padx=5)
