...
mydb = mysql.connector.connect(host="localhost",user="root",password="1234") ##Name RollNumber Hostel Room Mess MessPref Month Year Dept
...
sql = "INSERT INTO customers (name, address) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
